    ...
    <>
      ...
      <div style={{ position: 'relative', minHeight: '100vh', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 10, maxWidth: 780, margin: '0 auto', padding: '7rem 1.5rem 4rem' }}>
          <div style={{ background: 'rgba(1,60,28,0.9)', backdropFilter: 'blur(24px)', border: '1.5px solid rgba(212,162,76,0.7)', boxShadow: '0 0 0 1px rgba(212,162,76,0.18), 0 10px 30px rgba(0,0,0,0.28)', borderRadius: '16px', padding: '2rem 2.1rem' }}>
