...
const CARD = { background: 'rgba(1,60,28,0.9)', backdropFilter: 'blur(24px)', border: '1.5px solid rgba(212,162,76,0.7)', boxShadow: '0 0 0 1px rgba(212,162,76,0.18), 0 10px 30px rgba(0,0,0,0.28)', borderRadius: '16px', padding: '1.75rem 1.9rem', marginBottom: '1.25rem', textAlign: 'center' };
    ...
    <>
      ...
      <div style={{ position: 'relative', minHeight: '100vh', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 10, maxWidth: 780, margin: '0 auto', padding: '7rem 1.5rem 4rem' }}>
          <div style={{ background: 'rgba(1,60,28,0.9)', backdropFilter: 'blur(24px)', border: '1.5px solid rgba(212,162,76,0.7)', boxShadow: '0 0 0 1px rgba(212,162,76,0.18), 0 10px 30px rgba(0,0,0,0.28)', borderRadius: '16px', padding: '2rem 2.5rem', marginBottom: '1.25rem', textAlign: 'center' }}>
          ...
          <div style={CARD}>
            ...
            <div style={{ marginBottom: '1.8rem' }}>
              <img src="/kristina.jpg" alt="Kristina Castro, Nurse Practitioner at Healing Soulutions" style={{ width: 140, height: 140, borderRadius: '50%', objectFit: 'cover', border: '2px solid var(--gold-soft)', boxShadow: '0 0 0 5px rgba(212,162,76,0.15)' }} />
              ...
              <p style={{ ...P, maxWidth: 560, marginLeft: 'auto', marginRight: 'auto' }}>Kristina is a board-certified Family Nurse Practitioner with more than a decade at the bedside in New York ICUs and emergency departments &mdash; the settings where clinical judgment matters most. Today she pairs that acute-care foundation with functional medicine and peptide therapy, with a scope that spans the full lifespan &mdash; children, adults, and older adults alike. With experience caring for patients both in New York and abroad, she assesses, diagnoses, prescribes, and oversees every plan personally, delivered privately at home.</p>
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '1.8rem' }}>
              <img src="/berit.jpg" alt="Berit Tran, Registered Nurse and founder of Healing Soulutions" style={{ width: 140, height: 140, borderRadius: '50%', objectFit: 'cover', border: '2px solid var(--gold-soft)', boxShadow: '0 0 0 5px rgba(212,162,76,0.15)' }} />
              ...
              <p style={{ ...P, maxWidth: 560, marginLeft: 'auto', marginRight: 'auto' }}>Berit is a registered nurse with over fifteen years in New York hospitals across the emergency department, ICU, med-surg, and post-surgical and anesthesia recovery care &mdash; the full arc of acute nursing. Her experience also includes fertility optimization and IVF support, with a special interest and focus in supplementation for autoimmune support, hormone health, metabolic health, and brain health and sleep architecture optimization. She has cared for patients across New York State and abroad, and now serves the New York metropolitan area. Through Healing Soulutions, she brings that depth into the home with discretion, privacy, and attentiveness.</p>
              <p style={{ ...P, fontSize: '0.7rem', color: 'rgba(255,255,255,0.6)', maxWidth: 560, marginLeft: 'auto', marginRight: 'auto', marginBottom: 0 }}>BSN &middot; Licensed RN &middot; ACLS &middot; PALS &middot; BLS</p>
            </div>
