      ...
      <div style={{ position: 'relative', minHeight: '100vh', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 10, maxWidth: 780, margin: '0 auto', padding: '7rem 1.5rem 4rem' }}>
          <div style={{ background: 'rgba(8,44,26,0.9)', backdropFilter: 'blur(24px)', border: '1.5px solid rgba(219,170,100,0.7)', boxShadow: '0 0 0 1px rgba(219,170,100,0.18), 0 10px 30px rgba(0,0,0,0.28)', borderRadius: '16px', padding: '2rem 2.5rem', marginBottom: '1.25rem', textAlign: 'center' }}>
            ...
            <p style={{ fontFamily: "'Varela Round',sans-serif", fontSize: '0.92rem', lineHeight: 1.72, color: '#D9AC63', textAlign: 'center', marginBottom: '0.9rem', maxWidth: 540, marginLeft: 'auto', marginRight: 'auto', textShadow: '0 1px 2px rgba(0,0,0,0.35)' }}>Healing Soulutions began with a simple conviction: that skilled, compassionate nursing care should meet you where you are — in the comfort of your home, surrounded by the people and things that bring you peace. Too often, healing is something that happens in waiting rooms and hallways. We believe it happens best where you feel most like yourself.</p>
            <p style={{ fontFamily: "'Varela Round',sans-serif", fontSize: '0.92rem', lineHeight: 1.72, color: '#D9AC63', textAlign: 'center', marginBottom: '0.9rem', maxWidth: 540, marginLeft: 'auto', marginRight: 'auto', textShadow: '0 1px 2px rgba(0,0,0,0.35)' }}>Our mission is to bring expert care to your door, and to treat every person not as a patient or a case, but as a whole human being — with dignity, warmth, and genuine attention. We walk alongside you through recovery, wellness, and everything in between, so you can focus on living fully.</p>
            <p style={{ fontFamily: "'Varela Round',sans-serif", fontSize: '0.92rem', lineHeight: 1.72, color: '#D9AC63', textAlign: 'center', margin: 0, maxWidth: 540, marginLeft: 'auto', marginRight: 'auto', fontStyle: 'italic', textShadow: '0 1px 2px rgba(0,0,0,0.35)' }}>This is care as it should be: expert, unhurried, and deeply personal. This is the Healing Soulutions experience.</p>
