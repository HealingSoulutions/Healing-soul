    ...
    <div style={{ position: 'relative', minHeight: '100vh', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 10 }}>
        <div style={{ padding: '8rem 3rem 0.75rem', textAlign: 'center', background: 'transparent', maxWidth: 800, margin: '0 auto' }}>
          <div style={{ background: 'rgba(1,60,28,0.9)', backdropFilter: 'blur(24px)', border: '1.5px solid rgba(212,162,76,0.7)', boxShadow: '0 0 0 1px rgba(212,162,76,0.18), 0 10px 30px rgba(0,0,0,0.28)', borderRadius: '16px', padding: '1.5rem', boxSizing: 'border-box', width: '100%' }}>
        ...
        <div style={{ padding: '0.5rem 3rem 3rem', maxWidth: 800, margin: '0 auto' }}>
          {serviceCategories.map((cat) => (
            <div key={cat.id} style={{ marginBottom: '0.75rem' }}>
              ...
              {openCat === cat.id && (
                <div style={{ background: 'rgba(1,60,28,0.9)', backdropFilter: 'blur(24px)', border: '1.5px solid rgba(212,162,76,0.7)', boxShadow: '0 0 0 1px rgba(212,162,76,0.18), 0 10px 30px rgba(0,0,0,0.28)', borderRadius: '12px', padding: '0.5rem', marginTop: '0.4rem' }}>
                  {cat.consultOnly && (
