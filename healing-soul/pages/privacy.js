...
export default function Privacy() {
  return (
    <LegalLayout title="Privacy Policy" effective="August 1, 2026"
      ...
      <Sec>This Privacy Policy explains how Healing Soulutions (a trade name used under license from BT RPN PLLC and Kristina Castro, Nurse Practitioner in Family Health, PLLC) collects, uses, and safeguards information submitted through this website. Protected Health Information you share as a patient is separately governed by our <a href="/notice-of-privacy-practices" style={{ color: 'var(--gold-soft)' }}>HIPAA Notice of Privacy Practices</a>, which is available on this website and provided at your first visit.</Sec>
      ...
      <Sec heading="Your Choices & Rights">You may request access to, correction of, or deletion of personal information, and may opt out of non-essential communications, subject to legal and recordkeeping requirements. Health-record rights are addressed in our <a href="/notice-of-privacy-practices" style={{ color: 'var(--gold-soft)' }}>HIPAA Notice of Privacy Practices</a>.</Sec>
