  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500&family=Varela+Round&family=Outfit:wght@400;500;600;700&display=swap"
          rel="stylesheet"
        />
      </Head>
      <body>
