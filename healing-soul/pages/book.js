      ...
      try {
        ...
        var appearance = {
          ...
          rules: {
            ...
            '.Tab--selected, .Tab--selected .TabLabel': {
              color: '#DBAA64',
            },
          },
        };
        ...
        <div style={{ padding: '0.5rem 3rem 3rem', maxWidth: 800, margin: '0 auto' }}>
          ...
          {step === 3 && (
            <div style={CS}>
              ...
              <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: '0.75rem', textAlign: 'center', marginBottom: '1.25rem', fontFamily: "'Varela Round',sans-serif" }}>Pay with card, Apple Pay, or Google Pay. A small, temporary hold may be placed to verify your card and is released automatically — no charge is made for your visit at this time.</p>
