                ...
                return (
                  <div key={s.num} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.25rem' }}>
                      <div style={{ width: 22, height: 22, borderRadius: '50%', background: active ? 'var(--gold-soft)' : 'rgba(255,255,255,0.15)', color: active ? '#013C1C' : 'rgba(255,255,255,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.5rem', fontWeight: 700, fontFamily: "'Outfit',sans-serif" }}>{done ? '\u2713' : s.num}</div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              ...
              <div style={CS}>
                ...
                <div style={{ marginBottom: '1rem' }}>
                  ...
                  {form.services.length > 0 && (
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.3rem', marginBottom: '0.5rem' }}>
                      {form.services.map((s) => (
                        <span key={s} style={{ display: 'inline-flex', alignItems: 'center', gap: '0.3rem', background: 'rgba(219,170,100,0.12)', border: '1px solid rgba(219,170,100,0.25)', borderRadius: '6px', padding: '0.2rem 0.5rem', fontSize: '0.45rem', color: 'var(--gold-soft)', fontFamily: "'Outfit',sans-serif", fontWeight: 500 }}>
                ...
                <div style={{ marginTop: '1.25rem', paddingTop: '1.25rem', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
                  ...
                  <button onClick={addPatient} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.4rem', width: '100%', padding: '0.65rem', background: 'rgba(255,255,255,0.06)', border: '1px dashed rgba(219,170,100,0.25)', borderRadius: '8px', color: 'var(--gold-soft)', fontFamily: "'Outfit',sans-serif", fontSize: '0.6rem', fontWeight: 500, cursor: 'pointer' }}><span style={{ fontSize: '0.85rem', lineHeight: 1 }}>+</span> Add Another Patient</button>
                </div>
                ...
                <div style={{ marginTop: '1.5rem', paddingTop: '1.5rem', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
                  ...
                  <div style={{ background: 'rgba(0,0,0,0.15)', borderRadius: '8px', padding: '0.85rem', marginBottom: '0.75rem', maxHeight: '160px', overflow: 'auto' }}>
                    {[
                      ...
                      ['(4)', ' I acknowledge that BT RPN PLLC, providing services under the licensed name Healing Soulutions, and their respective owners, officers, employees, contractors, agents, and affiliated clinicians shall not be held liable for any adverse outcomes, injuries, complications, or damages arising directly or indirectly from my failure to provide complete and accurate medical information.'],
                      ...
                      <p key={i} style={{ fontFamily: "'Outfit',sans-serif", fontSize: i === 0 ? '0.5rem' : '0.48rem', lineHeight: 1.7, color: 'rgba(255,255,255,0.75)', marginBottom: '0.4rem', ...(i > 0 ? { paddingLeft: '0.5rem', borderLeft: '2px solid rgba(219,170,100,0.15)' } : {}) }}>
            ...
            <div style={CS}>
              ...
              <div style={{ marginTop: '1rem', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '1rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '0.75rem' }}>
                  <button onClick={() => setSigMode('type')} style={{ padding: '0.4rem 0.8rem', fontSize: '0.55rem', fontFamily: "'Outfit',sans-serif", fontWeight: 500, background: sigMode === 'type' ? 'var(--gold-soft)' : 'rgba(255,255,255,0.1)', color: sigMode === 'type' ? '#013C1C' : 'rgba(255,255,255,0.6)', border: 'none', borderRadius: '6px', cursor: 'pointer' }}>Type Signature</button>
                  <button onClick={() => setSigMode('draw')} style={{ padding: '0.4rem 0.8rem', fontSize: '0.55rem', fontFamily: "'Outfit',sans-serif", fontWeight: 500, background: sigMode === 'draw' ? 'var(--gold-soft)' : 'rgba(255,255,255,0.1)', color: sigMode === 'draw' ? '#013C1C' : 'rgba(255,255,255,0.6)', border: 'none', borderRadius: '6px', cursor: 'pointer' }}>Draw Signature</button>
                </div>
                {sigMode === 'type' ? (
                  <div>
                    ...
                    {signature && signature !== 'drawn-signature' && (<div style={{ background: 'rgba(255,255,255,0.95)', borderRadius: '8px', padding: '1rem', textAlign: 'center' }}><p style={{ fontSize: '0.45rem', color: '#999', marginBottom: '0.3rem', fontFamily: "'Outfit',sans-serif" }}>Signature Preview</p><p style={{ fontFamily: 'Georgia,serif', fontSize: '1.2rem', color: '#013C1C', fontStyle: 'italic' }}>{signature}</p></div>)}
                  </div>
                ) : (
                  <div>
          ...
          {step === 3 && (
            <div style={CS}>
              ...
              <div style={{ background: 'rgba(1,60,28,0.95)', borderRadius: '12px', padding: '1.25rem', border: '1px solid rgba(219,170,100,0.15)' }}>
                ...
                {stripeFailed ? (
                  <div style={{ padding: '0.85rem', background: 'rgba(255,180,50,0.08)', border: '1px solid rgba(255,180,50,0.2)', borderRadius: '8px', marginBottom: '1rem' }}>
                    ...
                    <p style={{ fontSize: '0.48rem', color: 'rgba(255,255,255,0.7)', fontFamily: "'Outfit',sans-serif", lineHeight: 1.6 }}>Please refresh to try again, or continue and our team will contact you to collect payment securely. For your protection, we never accept card numbers typed into this form.</p>
                  </div>
                ) : (
              ...
              <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1.25rem' }}>
                ...
                <button onClick={handleStripePayment} disabled={!cardValid || isValidating} style={{ flex: 2, padding: '0.7rem', fontSize: '0.6rem', fontFamily: "'Outfit',sans-serif", fontWeight: 700, background: cardValid && !isValidating ? 'var(--gold-soft)' : 'rgba(255,255,255,0.1)', color: cardValid && !isValidating ? '#013C1C' : 'rgba(255,255,255,0.3)', border: 'none', borderRadius: '8px', cursor: cardValid && !isValidating ? 'pointer' : 'not-allowed', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.4rem' }}>
