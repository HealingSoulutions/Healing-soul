...
export default function Terms() {
  return (
    <LegalLayout title="Terms of Use" effective="August 1, 2026"
      ...
      <Sec>By accessing or using this website, you agree to these Terms of Use. If you do not agree, please do not use the site. This website is operated for Healing Soulutions, a trade name used under license from BT RPN PLLC (the "Practice").</Sec>
