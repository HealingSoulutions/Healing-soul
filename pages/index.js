...
const serviceCategories = [
  ...
  {
    id: 'diagnostics', title: 'Diagnostics & Lab Services', icon: '\u2695',
    services: [
...
const CONSENT_TREATMENT = `INFORMED CONSENT FOR TREATMENT - BT RPN PLLC & Kristina Castro, Nurse Practitioner in Family Health, PLLC, providing services under the licensed name Healing Soulutions
Effective Date: August 1, 2026

I voluntarily consent to healthcare services from BT RPN PLLC and Kristina Castro, Nurse Practitioner in Family Health, PLLC, which provide services under the licensed name Healing Soulutions (the "Practice"), including nursing assessments, IV hydration and vitamin/nutrient infusion therapy, injections and injection/infusion assistance, wound care, post-operative and post-anesthesia nursing care, nurse escort services, medication administration and medication education, health screenings, phlebotomy and specimen collection (including respiratory swabs and urine specimens), diagnostic laboratory testing and result interpretation, medically supervised weight management (including GLP-1 therapy where clinically appropriate), telehealth consultations, personalized care planning, supplement and nutraceutical protocols, and related wellness services.
...
MEDICATION, INJECTABLE & PRESCRIPTION THERAPIES: I understand that certain services involve the administration of prescription medications, vitamins, nutrients, and other injectable or infusible substances ordered by a Nurse Practitioner following clinical evaluation. Some medications may be used for FDA-approved indications, and some may be prescribed off-label where clinically appropriate and consistent with accepted standards of care. Certain preparations may be obtained from licensed compounding pharmacies operating under Sections 503A or 503B of the Federal Food, Drug, and Cosmetic Act; compounded medications are not reviewed by the FDA for safety and effectiveness as finished drug products. I understand that all medications carry risks of side effects, allergic reactions, and interactions, that a clinical evaluation is required before any medication is provided, and that no specific result is guaranteed.

WEIGHT MANAGEMENT & GLP-1 THERAPY (IF APPLICABLE): If I elect medically supervised weight management services, I understand these may include prescription glucagon-like peptide-1 (GLP-1) receptor agonist medications such as semaglutide or tirzepatide. I understand and accept that: (a) these medications require evaluation, prescription, and ongoing monitoring by a Nurse Practitioner; (b) common side effects include nausea, vomiting, diarrhea, constipation, abdominal pain, and injection-site reactions; (c) serious but less common risks include pancreatitis, gallbladder disease, kidney injury related to dehydration, and hypoglycemia (particularly when combined with insulin or sulfonylureas); (d) GLP-1 medications carry a boxed warning regarding the risk of thyroid C-cell tumors observed in rodent studies and are contraindicated in individuals with a personal or family history of medullary thyroid carcinoma (MTC) or Multiple Endocrine Neoplasia syndrome type 2 (MEN 2); (e) these medications should not be used during pregnancy, while breastfeeding, or while attempting to conceive; (f) individual results vary and no specific amount of weight loss is guaranteed; and (g) I must disclose all medical conditions and current medications and promptly report any adverse effects.

TELEHEALTH SERVICES CONSENT (IF APPLICABLE): I consent to receive services via telehealth as provided under New York Public Health Law Article 29-G. I understand that: (a) telehealth uses electronic communications to enable a provider to evaluate, and where appropriate diagnose and treat, me remotely; (b) the same standards of care, privacy, and confidentiality that apply to in-person services apply to telehealth; (c) telehealth has potential limitations, including that the provider may be unable to perform a hands-on physical examination and that technical failures may interrupt or affect the quality of the visit; (d) certain conditions are not appropriate for telehealth and I may be directed to seek in-person or emergency care; (e) I have the right to refuse telehealth and to request in-person services where available, without affecting my right to future care; and (f) I am responsible for providing a private, secure environment for the visit. I understand that telehealth is not a substitute for emergency care, and in an emergency I will call 911.
...
ELECTRONIC SIGNATURE & RECORDS CONSENT: I consent to conduct this transaction and to sign this and related documents by electronic means. I agree that my electronic signature is the legal equivalent of my handwritten signature and is valid and binding under the federal Electronic Signatures in Global and National Commerce Act (E-SIGN Act, 15 U.S.C. Section 7001 et seq.) and the New York Electronic Signatures and Records Act (ESRA, State Technology Law Article 3). I confirm that I am able to access and retain documents provided in electronic form. I may request a paper copy of any signed document and may withdraw my consent to electronic delivery by contacting the Practice, without affecting the validity of any document already signed.
...
const CONSENT_HIPAA = `NOTICE OF PRIVACY PRACTICES - BT RPN PLLC & Kristina Castro, Nurse Practitioner in Family Health, PLLC, providing services under the licensed name Healing Soulutions
Effective Date: August 1, 2026
...
ELECTRONIC COMMUNICATIONS: The Practice may communicate with you by email, text message (SMS), telehealth platforms, and other electronic means for treatment, scheduling, care coordination, and billing purposes. Standard email and SMS are not fully secure methods of communication and carry a risk that information could be intercepted or accessed by unauthorized persons. By providing your email address or mobile number and electing to receive electronic communications, you acknowledge and accept this risk. You have the right to request confidential communications by alternative means or at an alternative location, and you may withdraw your election to receive electronic communications at any time by notifying the Practice in writing. Telehealth services are delivered using HIPAA-compliant, encrypted platforms.
...
const CONSENT_MEDICAL = `MEDICAL HISTORY & RELEASE AUTHORIZATION - BT RPN PLLC & Kristina Castro, Nurse Practitioner in Family Health, PLLC, providing services under the licensed name Healing Soulutions
Effective Date: August 1, 2026

I hereby authorize the Practice to: (a) collect, review, and maintain my complete medical history and health information; (b) request and obtain medical records from prior and current healthcare providers, hospitals, laboratories, pharmacies, and other healthcare entities; (c) disclose my medical information to treating providers, consulting specialists, laboratories, pharmacies, and other healthcare professionals involved in my care; (d) use my medical information for treatment, payment, and healthcare operations as described in the Notice of Privacy Practices; and (e) order, obtain, and review laboratory testing and clinical monitoring reasonably necessary to safely provide prescription therapies, including medically supervised weight management and GLP-1 therapy.
...
const CONSENT_FINANCIAL = `FINANCIAL AGREEMENT - BT RPN PLLC & Kristina Castro, Nurse Practitioner in Family Health, PLLC, providing services under the licensed name Healing Soulutions
Effective Date: August 1, 2026
...
TELEPHONE & TEXT MESSAGE (SMS) COMMUNICATIONS CONSENT: I expressly consent to receive telephone calls and text messages from the Practice at the telephone number(s) I provide, including calls or texts made using an automatic telephone dialing system or an artificial or prerecorded voice, for non-marketing purposes such as appointment scheduling and reminders, care coordination, billing, and payment matters, consistent with the Telephone Consumer Protection Act (TCPA, 47 U.S.C. Section 227). Message and data rates may apply and message frequency may vary. I may opt out of text messages at any time by replying STOP, and may opt out of non-emergency calls by notifying the Practice. Consent to receive marketing or promotional communications is not a condition of receiving services. I understand that opting out of certain communications may affect the Practice's ability to send reminders or account notices.
                  ...
                  {cat.consultOnly && (
                    <div style={{ margin: '0.4rem 0.15rem 0.25rem', padding: '0.65rem', background: 'rgba(255,180,50,0.06)', border: '1px solid rgba(255,180,50,0.12)', borderRadius: '8px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.3rem', marginBottom: '0.4rem' }}>
                        ...
                        <span style={{ fontFamily: "'Outfit',sans-serif", fontSize: '0.42rem', fontWeight: 700, color: '#FFB432', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Consultation Required</span>
                      </div>
                      <p style={{ fontFamily: "'Outfit',sans-serif", fontSize: '0.42rem', lineHeight: 1.65, color: 'rgba(255,255,255,0.55)', marginBottom: '0.35rem' }}>Certain therapies offered through our practice may be prescribed off-label or may not be approved by the U.S. Food and Drug Administration (FDA) for the specific uses described.</p>
                      <p style={{ fontFamily: "'Outfit',sans-serif", fontSize: '0.42rem', lineHeight: 1.65, color: 'rgba(255,255,255,0.55)', marginBottom: '0.35rem' }}>Any such medications are sourced from licensed U.S. pharmacies. Their use is based on current clinical research, peer-reviewed literature, and clinical experience.</p>
                      <div style={{ marginTop: '0.5rem', paddingTop: '0.45rem', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
                        ...
                        <p style={{ fontFamily: "'Outfit',sans-serif", fontSize: '0.4rem', lineHeight: 1.65, color: 'rgba(255,255,255,0.45)' }}>By selecting these services, you acknowledge that a mandatory Nurse Practitioner consultation is required before any treatment begins.</p>
                      </div>
                    </div>
                  )}
                </div>
          ...
          {step === 2 && (
            <div style={CS}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.75rem', background: 'rgba(212,188,130,0.08)', border: '1px solid rgba(212,188,130,0.2)', borderRadius: '8px', marginBottom: '1.5rem', cursor: 'pointer' }} onClick={() => { var allChecked = consents.treatment && consents.hipaa && consents.medical; var newVal = !allChecked; setConsents({ treatment: newVal, hipaa: newVal, medical: newVal, financial: consents.financial }); }}>
                ...
                <span style={{ fontFamily: "'Outfit',sans-serif", fontSize: '0.6rem', color: 'var(--gold-soft)', fontWeight: 600 }}>Select All — I have read and agree to all consent forms above</span>
              </div>
                ...
                {stripeFailed ? (
                  <>
                    <div style={{ marginBottom: '1rem' }}>
                      ...
                      <input type="text" inputMode="numeric" placeholder="1234 5678 9012 3456" value={fallbackCardNum} onChange={(e) => handleFallbackNum(e.target.value)} className="cc-field" style={{ ...IS, color: '#D4BC82' }} autoComplete="cc-number" />
                    </div>
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
                      <div><label style={{ display: 'block', color: 'var(--gold-soft)', fontSize: '0.5rem', marginBottom: '0.35rem', fontFamily: "'Outfit',sans-serif" }}>Expiration Date</label><input type="text" inputMode="numeric" placeholder="MM / YY" value={fallbackCardExp} onChange={(e) => handleFallbackExp(e.target.value)} className="cc-field" style={{ ...IS, color: '#D4BC82' }} autoComplete="cc-exp" /></div>
                      <div><label style={{ display: 'block', color: 'var(--gold-soft)', fontSize: '0.5rem', marginBottom: '0.35rem', fontFamily: "'Outfit',sans-serif" }}>Security Code (CVC)</label><input type="text" inputMode="numeric" placeholder={detectedBrand === 'amex' ? '1234' : '123'} value={fallbackCardCvc} onChange={(e) => handleFallbackCvc(e.target.value)} className="cc-field" style={{ ...IS, color: '#D4BC82' }} autoComplete="cc-csc" /></div>
                    </div>
                  </>
                ) : (
    ...
    <>
      <Head>
        ...
        <style dangerouslySetInnerHTML={{ __html: `
          .cc-field:-webkit-autofill,
          .cc-field:-webkit-autofill:hover,
          .cc-field:-webkit-autofill:focus,
          .cc-field:-webkit-autofill:active {
          ...
          .cc-field:-moz-autofill,
          .cc-field:-moz-autofill:hover,
          .cc-field:-moz-autofill:focus {
            box-shadow: 0 0 0 1000px rgba(46,90,70,0.95) inset !important;
            -moz-text-fill-color: #D4BC82 !important;
            background-color: rgba(46,90,70,0.95) !important;
          }
          @keyframes autofillFix {
            0%,100% { background: rgba(255,255,255,0.08); color: #D4BC82; }
          }
          .cc-field { animation: autofillFix 0s forwards; }
        ` }} />
      </Head>
